...
class AddMaterialRates extends StatefulWidget {
  const AddMaterialRates({super.key});

  @override
  State<AddMaterialRates> createState() => _AddMaterialRates();
}

class _AddMaterialRates extends State<AddMaterialRates> {
  @override
...
class AddRates extends StatefulWidget {
  ...
  @override
  State<AddRates> createState() => _AddRates();
}

class _AddRates extends State<AddRates> {
  @override
  String city = "City";
  final cityItems = [
    "City",
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <
        ...
        const Padding(
            padding: EdgeInsets.only(left: 30, top: 20),
            child: Text(
              "Add new items and Also update material Prices account to the market ",
              style: TextStyle(
                  color: Colors.grey,
                  fontSize: 14,
                  fontWeight: FontWeight.w500),
        ...
        Row(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                const Padding(
                    padding: EdgeInsets.only(top: 40, left: 30, bottom: 0),
                    child: Text(
                      "Unit",
                      style: TextStyle(
                        color: Colors.black,
        ...
        Row(
          children: <Widget>[
            Padding(
                padding: const EdgeInsets.only(top: 30, left: 540, bottom: 40),
                child: SizedBox(
                    width: 140,
                    height: 35,
                    child: ElevatedButton(
