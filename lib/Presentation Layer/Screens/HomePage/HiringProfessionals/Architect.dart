...
import '../../Owner/Owner_Proposals_Architect.dart';
import '../footer.dart';
import '../header.dart';


class ArchitectMain extends StatefulWidget {
  const ArchitectMain({super.key});

  @override
  State<ArchitectMain> createState() => _ArchitectMain();
}

class _ArchitectMain extends State<ArchitectMain> {
  @override
...
class Architect extends StatefulWidget {
  const Architect({super.key});

  @override
  State<Architect> createState() => _Architect();
}

class _Architect extends State<Architect> {
  @override
  Widget build(BuildContext context) {
    return Column(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                            ...
                            child: Text(
                              '''
Architects are professionally trained to help you plan, design 
and implement your project. An architect has typically been
through the design and build process many times before, on 
different sites and locations, dealt with a range of surprises
and challenges, and managed a number of different needs
and requirements.''',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(
                            "HiringWorkersImages/HiringArcitect.jpg"),
                        fit: BoxFit.cover)),
              ),
            )
          ],
...
class TopRatedArchitect extends StatefulWidget {
  const TopRatedArchitect({super.key});

  @override
  State<TopRatedArchitect> createState() => _TopRatedArchitect();
}

class _TopRatedArchitect extends State<TopRatedArchitect> {
  @override
  bool onChange = false;
  Widget build(BuildContext context) {
    return Container(
...
class SearchArchitect extends StatefulWidget {
  const SearchArchitect({super.key});

  @override
  State<SearchArchitect> createState() => _SearchArchitect();
}

class _SearchArchitect extends State<SearchArchitect> {
  @override
...
class getAllArchitect extends StatefulWidget {
  @override
  State<getAllArchitect> createState() => _getAllArchitectState();
}

class _getAllArchitectState extends State<getAllArchitect> {
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
