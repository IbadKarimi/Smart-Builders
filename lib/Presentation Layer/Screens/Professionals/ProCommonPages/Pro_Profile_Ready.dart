...
class NiceWork extends StatefulWidget {
  const NiceWork({super.key});

  @override
  State<NiceWork> createState() => _NiceWork();
}

class _NiceWork extends State<NiceWork> {
  @override
...
class NiceWorkInterface extends StatefulWidget {
  const NiceWorkInterface({super.key});

  @override
  State<NiceWorkInterface> createState() => _NiceWorkInterface();
}

class _NiceWorkInterface extends State<NiceWorkInterface> {
  @override
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    return Container(
