...
class ProViewRequestedProposals extends StatefulWidget {
  ...
  ProViewRequestedProposals(this.email,this.projectTitle,this.projectType,this.workMonth,this.projectBudget,
      this.plotFrontSideWidth,this.plotBackSideWidth,this.plotLeftSideLength,
      this.plotRightSideLength,this.actualPlotSize,this.city,this.plotLocation,this.describeYourProject,this.OwnerfirstName,
                                ...
                                child: ElevatedButton(
                                    onPressed: () {
                                     Navigator.of(context).push(MaterialPageRoute(
                                          builder: (context) =>
                                     ViewProposalRequestedProposalList(email.toString())));//professsioal_view_requested_proposal_list naviagte krna hai
                                    },
