...
class ViewProposalMain extends StatefulWidget {
  const ViewProposalMain({super.key});

  @override
  State<ViewProposalMain> createState() => _ViewProposalMain();
}

class _ViewProposalMain extends State<ViewProposalMain> {
  @override
                ...
                Column(
                    ...
                    children: const [
                      ...
                      Padding(
                          ...
                          child: Text(
                            "Proposal Posted 2 hours ago by you",
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 16,
                              fontWeight: FontWeight.w500,
                      ...
                      Padding(
                          padding:
                              EdgeInsets.only(top: 10, left: 20, bottom: 0),
                          child: Text(
                            "Proposal Posted on Dec-18-2022",
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 16,
                              fontWeight: FontWeight.w500,
