...
class AcceptedOffersMain extends StatefulWidget {
  const AcceptedOffersMain({super.key});

  @override
  State<AcceptedOffersMain> createState() => _AcceptedOffersMain();
}

class _AcceptedOffersMain extends State<AcceptedOffersMain> {
  @override
...
class AcceptedOffers extends StatefulWidget {
  const AcceptedOffers({super.key});

  @override
  State<AcceptedOffers> createState() => _AcceptedOffers();
}
