...
import '../../HomePage/ProjectProposals.dart';
...
class AcceptedProposalMain extends StatefulWidget {
  const AcceptedProposalMain({super.key});

  @override
  State<AcceptedProposalMain> createState() => _AcceptedProposalMain();
}

class _AcceptedProposalMain extends State<AcceptedProposalMain> {
  @override
...
class AcceptedProposal extends StatefulWidget {
  const AcceptedProposal({super.key});

  @override
  State<AcceptedProposal> createState() => _AcceptedProposal();
}

class _AcceptedProposal extends State<AcceptedProposal> {
  @override
  Widget build(BuildContext context) {
    return Container(
        width: 800,
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const ProjectProposalMain()));
            },
...
class Button extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: <Widget>[
        Padding(
            padding: const EdgeInsets.only(top: 10, left: 360, bottom: 20),
            child: Container(
                width: 140,
                height: 35,
                child: ElevatedButton(
