...
class OwnersAcceptDeclineOffer extends StatefulWidget {
  const OwnersAcceptDeclineOffer({super.key});

  @override
  State<OwnersAcceptDeclineOffer> createState() => _OwnersAcceptDeclineOffer();
}

class _OwnersAcceptDeclineOffer extends State<OwnersAcceptDeclineOffer> {
  @override
