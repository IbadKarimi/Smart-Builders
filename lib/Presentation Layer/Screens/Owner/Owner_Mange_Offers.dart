...
class OwnerManageOffers extends StatefulWidget {
  const OwnerManageOffers({super.key});

  @override
  State<OwnerManageOffers> createState() => _OwnerManageOffers();
}

class _OwnerManageOffers extends State<OwnerManageOffers> {
  @override
