...
class OwnerManageAppliedContract extends StatefulWidget {
  const OwnerManageAppliedContract({super.key});

  @override
  State<OwnerManageAppliedContract> createState() =>
      _OwnerManageAppliedContract();
}

class _OwnerManageAppliedContract extends State<OwnerManageAppliedContract> {
  @override
        ...
        body: SingleChildScrollView(
            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[Boxes(), Offers(), Button(), Footer()],
                ))));
  }
}
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const OwnersAcceptDeclineOffer()));
            },
