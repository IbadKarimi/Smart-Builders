...
class OwnerManageAcceptedOffers extends StatefulWidget {
  const OwnerManageAcceptedOffers({super.key});

  @override
  State<OwnerManageAcceptedOffers> createState() =>
      _OwnerManageAcceptedOffers();
}

class _OwnerManageAcceptedOffers extends State<OwnerManageAcceptedOffers> {
  @override
...
class _AcceptedOffers extends StatefulWidget {
  const _AcceptedOffers({super.key});

  @override
  State<_AcceptedOffers> createState() => __AcceptedOffers();
}

class __AcceptedOffers extends State<_AcceptedOffers> {
  @override
  Widget build(BuildContext context) {
    return Container(
        width: 800,
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) =>
                      const OwnersAcceptOfferApplyContract()));
            },
                      ...
                      children: const [
                        ...
                        Padding(
                            padding:
                                EdgeInsets.only(top: 10, left: 20, bottom: 0),
                            child: Text(
                              "Accepted Offer Saved Dec-18-2022",
                              style: TextStyle(
                                color: Colors.grey,
                                fontSize: 16,
                                fontWeight: FontWeight.w500,
                        ...
                        Padding(
                            padding:
                                EdgeInsets.only(top: 10, left: 20, bottom: 0),
                            child: Text(
                              "Contract for this offer is not Applied!",
                              style: TextStyle(
                                color: Colors.red,
                                fontSize: 16,
                                fontWeight: FontWeight.w500,
                          ...
                          Row(
                            children: [
                              const Padding(
                                  ...
                                  child: Text(
                                    "Contract  for this offer is applied",
                                    style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 16,
                                      fontWeight: FontWeight.w500,
