...
class OwnerViewProOffers extends StatefulWidget {
  ...
  OwnerViewProOffers(this._currentUserEmailVRP,this.id,this.email,this.status,this.projectTitle,this.projectType,this.workMonth,this.projectBudget,
      ...
      this.OwnerlastName,this.Ownercity,this.Ownercountry,this.OwnerProfilePicture,this.offer,this.offerSavedDate,
                                ...
                                child: ElevatedButton(
                                    onPressed: () {
                                      Navigator.of(context).push(MaterialPageRoute(
                                          builder: (context) =>
                                              OwnerOfferList(_currentUserEmailVRP.toString())));//professsioal_view_requested_proposal_list naviagte krna hai
                                    },
                    ...
                    Padding(
                        ...
                        child: Container(
                            ...
                            child: ElevatedButton(
                                onPressed: () async{
                                  ...
                                  var response2=await apiService.updateStatus(id.toString(), "Accepted",);
                                  if(response2=="200"){
                                    setState(() {
                      ...
                      Padding(
                          ...
                          child: Container(
                              ...
                              child: ElevatedButton(
                                  onPressed: () async{
                                    var response=await apiService.SetOffer(id.toString(), "Rejected");
                                    if(response=='200'){
                                      Navigator.of(
                                          context)
                                          .push(MaterialPageRoute(
                                          builder:
                                              (context) =>
                                          OwnerViewProfile(_currentUserEmailVRP.toString())));
                                    }
                  ...
                  Padding(
                      ...
                      child: Container(
                          ...
                          child: ElevatedButton(
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => OwnerViewProfile(_currentUserEmailVRP.toString())));
                              },
                              // ignore: sort_child_properties_last
