...
class HireArchitect extends StatefulWidget {
  const HireArchitect({super.key});

  @override
  State<HireArchitect> createState() => _HireArchitect();
}

class _HireArchitect extends State<HireArchitect> {
  @override
    ...
    return Container(
      ...
      child: Column(children: <Widget>[
        const Padding(
            ...
            child: Text(
              "Got it.Now create a plan for desire building",
              style: TextStyle(
        ...
        Padding(
            ...
            child: Row(
              children: <Widget>[
                ...
                const Text(
                  'If plan is created then click the checkbox and proceed to continue',
